...
final class PostDetailsNode: ASDisplayNode {
    let collectionNodeFlowLayout: PostDetailsCollectionViewLayout
    let collectionLayoutInspector: PostDetailsCollectionViewLayoutInspector
    ...
    required init(viewModel vm: PostDetailsViewModel) {
        ...
        collectionNodeFlowLayout = PostDetailsCollectionViewLayout()
        collectionLayoutInspector = PostDetailsCollectionViewLayoutInspector(layout: collectionNodeFlowLayout)
        collectionNode = PostDetailsNode.setupCollectionNode(flowLayout: collectionNodeFlowLayout, layoutInspector: collectionLayoutInspector)
        super.init()
    ...
    private static func setupCollectionNode(flowLayout: PostDetailsCollectionViewLayout, layoutInspector: PostDetailsCollectionViewLayoutInspector) -> ASCollectionNode {
