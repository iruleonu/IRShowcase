...
class PostDetailsCellNode: ASCellNode {
    ...
    required init(viewModel vm: PostDetailsCellViewModel) {
        titleTextNode = PostDetailsCellNode.setupTitleNode(text: vm.title)
        subtitleTextNode = PostDetailsCellNode.setupSubtitleNode(text: vm.subtitle)
        super.init()
