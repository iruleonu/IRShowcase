...
protocol PostDetailsCollectionViewLayoutDelegate: ASCollectionDelegate {
...
class PostDetailsCollectionViewLayout: UICollectionViewFlowLayout {
    public weak var delegate: PostDetailsCollectionViewLayoutDelegate?
...
class PostDetailsCollectionViewLayoutInspector: NSObject, ASCollectionViewLayoutInspecting {
    var layout: PostDetailsCollectionViewLayout?
    
    init(layout l: PostDetailsCollectionViewLayout) {
        super.init()
        layout = l
    }
