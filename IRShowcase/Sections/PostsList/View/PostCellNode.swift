...
class PostCellNode: ASCellNode {
    ...
    required init(viewModel vm: PostsListCellViewModel) {
        titleTextNode = PostCellNode.setupTitleNode(text: vm.title)
        subtitleTextNode = PostCellNode.setupSubtitleNode(text: vm.subtitle)
        super.init()
