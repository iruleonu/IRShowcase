//
//  PostsListCollectionViewLayout.swift
//  IRShowcase
//
...
class PostsListCollectionViewLayout: UICollectionViewFlowLayout {
...
class PostsListCollectionViewLayoutInspector: NSObject, ASCollectionViewLayoutInspecting {
    var layout: PostsListCollectionViewLayout?
    
    init(layout l: PostsListCollectionViewLayout) {
        super.init()
        layout = l
    }
