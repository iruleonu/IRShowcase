...
class PostDetailsViewModelTests: QuickSpec {
    override func spec() {
        describe("PostDetailsViewModelTests") {
            var subject: PostDetailsViewModelImpl!
            ...
            beforeEach {
                ...
                subject = PostDetailsViewModelImpl(routing: routing, postId: postId, userDataProvider: userDataProvider, postDataProvider: postDataProvider, commentsDataProvider: commentsDataProvider, connectivity: connectivity)
            }
