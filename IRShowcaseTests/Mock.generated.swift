...
open class PostsListRoutingMock: PostsListRouting, Mock {
    ...
    open func showPost(id: Int, action: @escaping (PostListAction) -> Void) {
    ...
    public struct Verify {
        ...
        public static func showPost(id: Parameter<Int>, action: Parameter<(PostListAction) -> Void>) -> Verify { return Verify(method: .m_showPost__id_idaction_action(`id`, `action`))}
    }
    ...
    public struct Perform {
        ...
        public static func showPost(id: Parameter<Int>, action: Parameter<(PostListAction) -> Void>, perform: @escaping (Int, @escaping (PostListAction) -> Void) -> Void) -> Perform {
